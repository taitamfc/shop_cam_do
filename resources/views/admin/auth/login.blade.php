    ...
    <body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="app-brand justify-content-center">
                                <a href="javascript:void(0)" class="app-brand-link gap-2">
                                    ...
                                    <span class="app-brand-text demo text-body fw-bold">H89</span>
                                </a>
                            </div>
                            <!-- /Logo -->
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                // Get the password input field and the show/hide icon
                const passwordInput = document.getElementById("password");
                const showHideIcon = document.querySelector(".input-group-text.cursor-pointer i");

                // Add a click event listener to the show/hide icon
